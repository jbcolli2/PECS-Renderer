...
******************************************************************/
void pecs::keyCallback(GLFWwindow *window, int key, int scancode, int action, int mod)
{
    Input::GetInstance().m_unhandledKeys.push(KeyEvent{key, action, mod});
}

void pecs::cursorPositionCallback(GLFWwindow *window, double xPosition, double yPosition)
{
    Input::GetInstance().m_mouseX = static_cast<float>(xPosition);
    Input::GetInstance().m_mouseY = static_cast<float>(yPosition);
}

void pecs::mouseButtonCallback(GLFWwindow *window, int button, int action, int mods)
{
